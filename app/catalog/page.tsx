    ...
    return (
      <div className="min-h-screen p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Fetching top developers and their star categories...</p>
        </div>
      </div>
    )
  }
          ...
          <Card className="w-full">
            <CardHeader className="pb-2">
              <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-foreground">{selectedDeveloper.bio}</p>
            ...
            <CardContent>
              <div className="mb-6 p-4 bg-accent rounded-lg border">
                <h3 className="font-medium text-accent-foreground mb-2">Developer Insight</h3>
                <p className="text-foreground">{selectedDeveloper.insightSummary}</p>
              </div>
                  ...
                  <Card key={repo.name} className="hover:shadow-md transition-shadow duration-200">
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex items-center bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-200 text-xs px-2 py-1 rounded-full">
